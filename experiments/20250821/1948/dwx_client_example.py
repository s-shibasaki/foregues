...
class tick_processor():
    ...
    def __init__(self, MT4_directory_path, 
        ...
        self.dwx.get_historic_data('EURUSD', 'M1', start.timestamp(), end.timestamp())
    ...
    def on_bar_data(self, symbol, time_frame, time, open_price, high, low, close_price, tick_volume):
        ...
        try:
            print(list(self.dwx.historic_data['EURUSD_M1'].keys())[-5:])
        except:
            print('error')
            pass
...
MT4_files_dir = 'C:/Users/imetk/AppData/Roaming/MetaQuotes/Terminal/F1D4EC898F870CDBB48BEE50DC4D8C21/MQL4/Files'
